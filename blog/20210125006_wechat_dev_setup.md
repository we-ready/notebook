...
> 公众号 ==>> 设置与开发 ==>> 公众号设置 ==>> 功能设置 ==>> JS接口安全域名（设置，添加域名，在域名指向的服务器下，安置指定的 TXT 文件）
> 确保微信能访问到域名下指定的 TXT 文件
...
服务号 - 接口权限 - 功能服务 - 微信支付 - 申请 ！！！（正向申请）
商户号主动输入服务号的 AppId 关联，然后回到 服务号接口权限里面确认（反向申请）
